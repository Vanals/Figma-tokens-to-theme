# #!/bin/bash
# # TODO replace XXX with App agreed name
# # This script creates a branch to trigger the release process for XXX. It will create a branch that signifies to the pipeline what type of update you are creating patch, minor, or major.
...
#     # TODO extra code for updating build files
#     yarn style-dictionary:build
#     # TODO release only build files, add code to export them too 
